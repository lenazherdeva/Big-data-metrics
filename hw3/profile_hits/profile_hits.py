...
def main(date):
    conf = SparkConf().setAppName("Profile hits")
    ...
    profiles_with_hits = fields.groupByKey().mapValues(get_hits_for_hour)
    profiles_with_hits_dict = dict(profiles_with_hits.collect())
